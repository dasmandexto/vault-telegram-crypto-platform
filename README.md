...
* **Фьючерсная торговля (USDT-M Futures)**:
  ...
  * Интерактивный свечной график с авторским алгоритмом **Anti-Collision Pill Labels** (метки открытых ордеров автоматически разводятся по высоте и не накладываются друг на друга).
